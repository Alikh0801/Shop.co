...
const Footer = () => {
    return (
        <footer className="bg-[#F0F0F0] pt-10 pb-10 relative mt-32">
            {/* 1. Newsletter Bölməsi - Mütləq mövqedə (absolute) yuxarıda durur */}
            <div className="container mx-auto px-4 absolute -top-24 left-1/2 -translate-x-1/2 w-full">
                <div className="bg-black rounded-[20px] py-9 px-6 md:px-16 flex flex-col lg:flex-row items-center justify-between gap-8">
                    <h2 className="text-white text-3xl md:text-4xl font-black leading-tight max-w-137.5">
                        STAY UPTO DATE ABOUT OUR LATEST OFFERS
                    </h2>
                    <div className="flex flex-col gap-3 w-full max-w-87.5">
                        ...
                        <button className="bg-white text-black py-3 rounded-full font-medium hover:bg-gray-200 transition-all text-sm">
            ...
            {/* 2. Linklər və Məlumat Bölməsi */}
            <div className="container mx-auto px-4 mt-24 md:mt-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 border-b border-gray-200 pb-12">
                    {/* Shop Məlumat */}
                    ...
                    <div>
                        <h4 className="font-bold uppercase tracking-widest mb-6 text-sm">Help</h4>
                        <ul className="flex flex-col gap-4 text-gray-600 text-sm">
                    ...
                    <div>
                        <h4 className="font-bold uppercase tracking-widest mb-6 text-sm">FAQ</h4>
                        <ul className="flex flex-col gap-4 text-gray-600 text-sm">
                    ...
                    <div>
                        <h4 className="font-bold uppercase tracking-widest mb-6 text-sm">Resources</h4>
                        <ul className="flex flex-col gap-4 text-gray-600 text-sm">
                ...
                <div className="flex items-center justify-between py-6 gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <img src="../images/cards/visa.png" alt="Visa" className="h-5 bg-white px-2 py-1 rounded shadow-sm" />
                        <img src="../images/cards/mc.webp" alt="Mastercard" className="h-5 bg-white px-2 py-1 rounded shadow-sm" />
                        <img src="../images/cards/paypal.png" alt="Paypal" className="h-5 bg-white px-2 py-1 rounded shadow-sm" />
                        <img src="../images/cards/applepay.png" alt="Apple Pay" className="h-5 bg-white px-2 py-1 rounded shadow-sm" />
                        <img src="../images/cards/googlepay.png" alt="Google Pay" className="h-5 bg-white px-2 py-1 rounded shadow-sm" />
                    </div>
                </div>
            </div>
        </footer>
